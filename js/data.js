...
(function () {
  ...
  const NAV = [
    ...
    },
    {
      ...
      items: [
        { id: 'empleados',    label: 'Empleados',     icon: 'fa-users',                 badge: '127' },
        { id: 'nomina',       label: 'Nómina',        icon: 'fa-money-check-dollar' },
        { id: 'flota',        label: 'Flota',         icon: 'fa-bus',                   badge: '48' },
        { id: 'costos',       label: 'Costos',        icon: 'fa-calculator' },
        { id: 'contabilidad', label: 'Contabilidad',  icon: 'fa-book' },
        { id: 'ocr',          label: 'OCR Facturas',  icon: 'fa-file-invoice-dollar' },
        { id: 'bi',           label: 'BI / Reportes', icon: 'fa-chart-bar' },
        { id: 'facturacion',  label: 'Facturación',   icon: 'fa-receipt' },
        { id: 'auditoria',    label: 'Auditoría',     icon: 'fa-shield-halved' },
      ],
    },
    {
      grupo: 'Comunicación',
      items: [
        ...
        { id: 'app-conductores', label: 'App Conductores', icon: 'fa-mobile-screen' },
